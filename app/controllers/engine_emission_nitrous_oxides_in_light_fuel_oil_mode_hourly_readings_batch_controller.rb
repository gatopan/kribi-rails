class EngineEmissionNitrousOxidesInLightFuelOilModeHourlyReadingsBatchController < AbstractBatchController
  def parent_model
    Engine
  end

  def children_model
    EngineEmissionNitrousOxidesInLightFuelOilModeHourlyReading
  end
