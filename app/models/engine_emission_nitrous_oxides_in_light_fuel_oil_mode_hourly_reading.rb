class EngineEmissionNitrousOxidesInLightFuelOilModeHourlyReading < AbstractIntervalModel
  PARENT_MODEL = Engine
  CUSTOM_NAME = 'Engine emission Nox in LFO mode hourly reading'
    ...
    mappings: [
      {
        ...
        destination: {
          ...
          worksheet_name: 'emission_nox_in_lfo_mode_hourly'
        }
      },
      {
        query: {
