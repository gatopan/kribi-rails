class CreateNewOilTankReceivingEvents < Kribi::Migration
  def change
    ...
    [
      ...
      add_index :new_oil_tank_receiving_events, "match_key_#{match_key_type}", name: "index_new_oil_tank_rece_event_mk_#{match_key_type}"
    end
  end
end
